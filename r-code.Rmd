...
The [data](https://data.cityofnewyork.us/Social-Services/311-Service-Requests-from-2010-to-Present/erm2-nwe9) from this article is updated daily, therefore my version of the file is quite a bit larger at 4.63 GB. Therefore, expect the charts return different results compared to the article. 
...
#### [twitter](https://twitter.com/ryanmdk) | email.ryan.kelly@gmail.com | [github]()